		...
		<VideoEditorContainer>
			<PreviewContainer>
				...
				<PreviewTextContainer>
					<PreviewText style={{ color: recipe.text1.color, fontFamily: recipe.text1.font, fontSize: 115 * recipe.text1.fontSize }}>{recipe.text1.text}</PreviewText>
					<PreviewText style={{ color: recipe.text2.color, fontFamily: recipe.text2.font, fontSize: 115 * recipe.text2.fontSize }}>{recipe.text2.text}</PreviewText>
				</PreviewTextContainer>
